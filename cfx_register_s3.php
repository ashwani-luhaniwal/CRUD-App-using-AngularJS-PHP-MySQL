      ...
      <hr />
        ...
        <div class="row">
          ...
          <div class="col-sm-6 form-box">
            ...
            <div class="f-space10"></div>
            <div class="add-user" ng-init="get_users()">
              ...
              <div class="people-group" ng-repeat="users in pagedItems">
                ...
                <div class="person-info">
                  <div class="user-fullname">{{ users.full_name }}</div>
                  <div class="row">
                    <div class="col-xs-6">
                      <p>Address: {{ users.addr_first }}</p>
                      <p>Address: {{ users.addr_second }}</p>
                      <p>Address: {{ users.addr_third }}</p>
                      <p>Postcode: {{ users.postcode }}</p>
                    </div>
                    <div class="col-xs-6">
                      <p>Position: {{ users.position }}</p>
                      <p>DOB: {{ users.dob }}</p>
                      <p>Email: {{ users.email_addr }}</p>
                      <p>Authorised: {{ users.authorized }}</p>
                    </div>
                  </div>
                </div>
                <div class="row">

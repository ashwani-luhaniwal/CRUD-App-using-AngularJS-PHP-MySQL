...
<head>
	<meta char-set="utf-8">
	<title>CFX Registration Form</title>
	...
	<script type="text/javascript" src="js/angular-initial-value.min.js"></script>
	<script type="text/javascript" src="js/angular-validate.js"></script>
